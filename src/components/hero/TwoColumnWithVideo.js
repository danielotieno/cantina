...
const Heading = tw.h1`font-black text-lg md:text-5xl leading-snug max-w-3xl`;
const Paragraph = tw.p`my-5 lg:my-8 text-lg lg:text-base font-black text-gray-100 max-w-lg mx-auto lg:mx-0`;
